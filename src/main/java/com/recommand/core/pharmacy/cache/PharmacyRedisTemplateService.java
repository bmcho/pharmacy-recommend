package com.recommand.core.pharmacy.cache;
...
public class PharmacyRedisTemplateService {
    ...
    public List<PharmacyDto> findAll() {
        try {
            ...
            for (String value : hashOperations.entries(CACHE_KEY).values()) {
                PharmacyDto pharmacyDto = deserializerPharmacyDto(value);
                list.add(pharmacyDto);
            }
            return list;
        } catch (Exception e) {
            log.error("[PharmacyRedisTemplateService find all error] {}", e.getMessage());
    ...
    public void delete(long id) {
        ...
        log.error("[PharmacyRedisTemplateService delete] {}", id);
    }
    ...
    private PharmacyDto deserializerPharmacyDto(String value) throws JsonProcessingException {
